...
.EXAMPLE
Invoke-Expression -Command (New-Object -TypeName System.Net.WebClient).downloadString('https://raw.githubusercontent.com/Vinebrook-Technology/Setup-Tasks/main/WindowsSandboxSetup.ps1')
